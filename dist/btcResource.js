...
async function chargeForRegistry(username, btcAddress, amount) {
    console.log(`${font_1.Font.fgCyan}${font_1.Font.bright}-----------------------------------------------\n` +
        ...
        `· Once the system receives this BTC, your exSat account (${font_1.Font.reset}${font_1.Font.bright} ${username.endsWith('.sat') ? username : `${username}.sat 0-df`} ${font_1.Font.fgCyan}) will be officially created on the exSat network. \n` +
